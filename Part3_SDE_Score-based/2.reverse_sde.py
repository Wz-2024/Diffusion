...
def transition_probability_diffusion_exact(x, t, params):
    ...
    pdf = norm.pdf(x, loc=x0,
                   scale=np.sqrt((sigma ** 2) * t))  # pdf of normal distribution with mean x0 and variance (sigma^2)*t
    return pdf
